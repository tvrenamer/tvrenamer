...
public class IOUtilities {
	...
	public static boolean moveFile(File source, File dest) {
		return moveFile(source, dest, null, false);
	} // }}}

	// {{{ moveFile() method with ProgressObserver and canStop
	public static boolean moveFile(File source, File dest, ProgressObserver observer, boolean canStop) {
		...
		if ((dest.exists() && dest.canWrite()) || (!dest.exists() && dest.getParentFile().canWrite())) {
			...
			try {
				...
				ok = copyStream(32768, observer, fis, fos, canStop);
	 ...
	 */
	public static boolean copyStream(int bufferSize, ProgressObserver progress, InputStream in, OutputStream out,
