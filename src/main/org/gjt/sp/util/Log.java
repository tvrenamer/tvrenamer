 ...
 * <p>
 * 
 * All events are logged to an in-memory buffer and optionally a stream, and those with a high urgency (warnings and
 * errors) are also printed to standard output.
 * <p>
 * 
...
public class Log {
	...
	public static void init(boolean stdio, int level) {
		...
		String[] props = { "java.version", "java.vm.version", "java.runtime.version", "java.vendor", "java.compiler",
			"os.name", "os.version", "os.arch", "user.home", "java.home", "java.class.path", };
	 ...
	 * 
	 * @param urgency
	 *            The urgency; can be one of <code>Log.DEBUG</code>, <code>Log.MESSAGE</code>, <code>Log.NOTICE</code>,
	 *            <code>Log.WARNING</code>, or <code>Log.ERROR</code>.
	 * @param source
