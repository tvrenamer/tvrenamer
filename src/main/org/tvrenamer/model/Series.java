...
public class Series extends Show {
    ...
    /**
     * Adds this series to the mapping of known series.
     *
     */
    private synchronized void addKnownSeries() {
        KNOWN_SERIES.put(idString, this);
    }
     ...
     * we just get the series's name and ID, but soon the
     ...
     *     such as a year.
     */
    public Series(int idNum, String name) {
